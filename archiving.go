...
// a directory and its contents as zip data for archiving file system.
package main
...
var (
	...
	flagPkg        = flag.String("p", "archiving", "Name of the generated package")
	flagPkgCmt     = flag.String("c", "Package archiving contains static assets.", "The package comment. An empty value disables this comment.\n")
)
...
// be read by the archiving/fs HTTP file system.
func generateSource(srcPath string) (file *os.File, err error) {
	...
	var qb bytes.Buffer
	fmt.Fprintf(&qb, `// Code generated by archiving. DO NOT EDIT.
%s%s
package %s
